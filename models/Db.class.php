...
class Db
{
    ...
    {
        try {		
                $this->_db = new PDO('pgsql:host=ec2-34-253-116-145.eu-west-1.compute.amazonaws.com;dbname=d4crfikr27qhql', 'siriyildxutgcz', 'e1bae29489482027cad1faca72fad9e1f8b6cb3519d46a4c0a2c669b6e4e6446');
